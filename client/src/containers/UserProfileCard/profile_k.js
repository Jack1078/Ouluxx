...
const Profile = () => {
  ...
  let testing = Get_User();
  testing.then((response) => {
    console.log(response);
    testing = response;
    // console.log(testing)

    const n = testing.FirstName + ' ' + testing.LastName;
    const a = testing.Address + ', ' + testing.State + ' ' + testing.Zipcode;
        ...
        <Modal.Body>
          <form className={classes.form} action='/users/update' method='POST'>
            <div className={classes.block}>
              ...
              <Row>
                <Col sm={6}>
                  <Textfield id='City-textfield' label='City' name='City' />
                </Col>
                <Col sm={6}>
                  <Textfield id='State-textfield' label='State' name='State' />
                </Col>
              </Row>
              <Textfield
