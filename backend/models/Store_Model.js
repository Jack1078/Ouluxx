...
const Store_Schema = new Schema({
  ...
  Inventory: {
    // A list of items. The item is added to this list to connect it with the database. More data on items is found in the Item_Schema.
    type: [
      {
        // contains the item ID, the items name, the date the item is added, and the number in the inventory.
        ItemID: String,
        ItemName: String,
        Date: Date,
